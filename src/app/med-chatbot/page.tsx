...
export default function MedChatBotPage() {
  ...
  return (
    <div className="p-4 flex flex-col h-full items-center space-y-2 select-none">
      ...
      <div
        className="flex-grow overflow-y-auto flex flex-col space-y-2"
        ref={chatHistoryDiv}
      >
        {chatHistory!.map((v, i) => (
          <div
      ...
      <div className="flex items-center bg-slate-100 -mx-2 w-full px-2 py-1 space-x-2">
        <label className="flex flex-col items-stretch w-full">
          <textarea
            className="appearance-none px-3 py-1 rounded-xl border-2 border-slate-300 focus:outline-teal-600 transition w-full min-h-[3rem]"
            value={chatText}
